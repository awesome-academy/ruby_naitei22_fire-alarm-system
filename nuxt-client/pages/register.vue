<template>
    <div>
        ...
        <form class="mt-8 space-y-6" @submit.prevent="handleRegister">
            <div
                v-if="message"
                :class="messageType === 'error' ? 'bg-red-50 border-red-200' : 'bg-green-50 border-green-200'"
            ...
            <div class="rounded-md shadow-sm flex flex-col gap-4">
                ...
                <div class="pt-2">
                    <label for="invitation-code" class="sr-only">Invitation Code</label>
                    <input
                        id="invitation-code"
...
onMounted(() => {
    const codeFromUrl = route.query.invitation_code as string | undefined;
    if (codeFromUrl) {
        formData.invitation_code = codeFromUrl;
    }
});

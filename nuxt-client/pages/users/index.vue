            ...
            try {
                ...
                const contentHtml = `
                    <div class="text-left text-sm space-y-2 swal-content-container">
                        <div class="flex"><strong class="w-28 text-gray-400">ID:</strong> <span class="font-mono text-xs text-gray-200">${userDetail.id}</span></div>
                        ...
                        <div class="flex"><strong class="w-28 text-gray-400">Created At:</strong> <span>${formatDateTime(userDetail.createdAt)}</span></div>
                        <div class="flex"><strong class="w-28 text-gray-400">Updated At:</strong> <span>${formatDateTime(userDetail.updatedAt)}</span></div>
                    </div>
                `;
                Swal.update({
